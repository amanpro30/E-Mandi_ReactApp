            ...
            <div class="col-xs-6 col-md-4">
              ...
              <ul class="list-unstyled">
                <li>
                  ...
                  <a href="https://www.facebook.com/E-Mandi" target="_blank">
                    {" "}
                    E-Mandi{" "}
                  </a>
                </li>
                <li>
                  ...
                  <a href="https://twitter.com/E-Mandi" target="_blank">
                    {" "}
                    @EMandi{" "}
                  </a>
                </li>
            ...
            <div class="col-xs-6 col-md-3">
              ...
              <ul class="list-unstyled">
                <li class="img-li">
                  ...
                  <a class="strong" href="callto:+91 9999999999">
                    +91 9999999999
                  </a>
                </li>
                <li class="img-li">
