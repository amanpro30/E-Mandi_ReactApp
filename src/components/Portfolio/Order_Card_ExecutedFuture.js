...
class Order_Card_ExecutedFuture extends Component{
                ...
                <Card.Body>
                    <Card.Text>
                        <tr className="col-xl-12">
                          <td className="col-md-1 align-middle">{this.props.CropName}</td>
                          <td className="col-md-2">{this.props.Quantity}</td>
                          <td className="col-md-2">{this.props.OrderDate}</td>
                          <td className="col-md-1">{this.props.Price}</td>
                          <td className="col-md-2">{this.props.DeliveryDate}</td>
                          <td className="col-md-2">{this.props.AdvanceDate}</td>
                          <td className="col-md-2">{this.props.Advance}</td>
                            </tr>
...
export default Order_Card_ExecutedFuture