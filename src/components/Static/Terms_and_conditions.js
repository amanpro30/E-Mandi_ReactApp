...
const Terms_and_conditions = props => (
  <Layout><br/><br/>
      <div className="content">
            ...
            <div className="termsConditions-title">TERMS AND CONDITIONS ₹MANDI</div>

            <p>Welcome to ₹Mandi! Thank you for using our online platform (“₹Mandi”). ₹Mandi is supplied by Agri EM, IN SRICITY. (“Agri EM”), with registered office at SRICITY in Andhra Pradesh</p>
            <p>By using ₹ Mandi, the User is accepting these terms and conditions in full and shall be legally bound to said terms and conditions, so he/she should read them carefully. Access to and use of ₹ Mandi depends solely on the acceptance of these Terms and Conditions.</p>
            ...
            <li className="termsConditions-list-item">
                ₹ Mandi -̶  online platform developed by Agri EM for the purchasing and selling of agricultural products and providing quality / quality certification services and logistics and agricultural products transportation services, in a wide variety of formats, prices and locations;</li>
            
            <li className="termsConditions-list-item">
                Account -̶ profile to be created by the User to have free access and use of the ₹ Mandi platform;
            </li>
            <li className="termsConditions-list-item">
                Customer(s) -̶  any professional(s) who use the ₹ Mandi platform to purchase agricultural products or request the provision of Services to a Seller or a Services Provider registered in the ₹ Mandi platform;
            </li>
            <li className="termsConditions-list-item">
                User -̶  any professional(s) who use the ₹ Mandi platform to purchase agricultural products, to sell, to provide or to request the provision of Services to any professional registered in the ₹ Mandi platform ;     
            </li>
            <li className="termsConditions-list-item">
                Request -̶  intention to request or requesting by the Customer of (i) the product that he/she intends to purchase and / or (ii) the Service that he/she intends to be provided by the Seller / Services Provider registered in  the ₹ Mandi platform;
            </li>
            <li className="termsConditions-list-item">
                Services Provider(s) -̶  legal person(s) registered in the ₹ Mandi platform to provide logistics and agricultural products transportation services and / or quality / quality certification services to the User(s), at his/her(their) request;
            </li>
            <li className="termsConditions-list-item">
                Payment Service Provider -̶  Lemon Way, with registered office at Rue de la Beaune, no. 15, Montreuil, France;
            </li>
            <li className="termsConditions-list-item">
                Professional -̶  legal person, Customer, Seller or Services Provider, registered in the ₹ Mandi platform, who intends, by this way, to purchase, to sell, to provide services or to request the provision of services;
            </li>
            <li className="termsConditions-list-item">
                Service(s) -̶  logistics and agricultural products transportation services and / or quality / quality certification services;
            </li>
            <li className="termsConditions-list-item">
                Seller(s) -̶  legal person(s) registered in the ₹ Mandi platform to sell agricultural products to User(s), at his/her (their) request.
            </li>
            </ul>
            <li className="termsConditions-list-title">RIGHTS AND LICENSE TO USE</li>
            <ul className="termsConditions-listNumeric">
            <li className="termsConditions-list-item">
                Subject to acceptance by the User of these Terms and Conditions, ₹ Mandi offers the User a limited, non-exclusive, non-sublicensable, revocable and non-transferable license to: (a) commercial use; (b) access to the platform on his/her personal equipment, solely for the purpose of using the platform services; and (c) access to and use any content, information and related materials that may be made available through the services of the ₹ Mandi platform. Any rights not expressly granted in these terms are reserved to Agri MP.
            </li>
            <li className="termsConditions-list-item">
                All rights on the ₹ Mandi platform are and remain the property of Agri EM or its licensors. Neither these Terms and Conditions, nor the use of the services of the ₹ Mandi platform, gives the User any rights: (a) on or related to the services, except for the limited license granted above; or (b) to use or, in any way, to refer to the company names of Agri MP, its affiliates or, where applicable, its licensors, its logos, product and service names, trademarks or other distinctive elements of Agri EM ownership.
            </li>
            <li className="termsConditions-list-item">
                The User is not authorized: (a) to remove any indication of intellectual property, including, without limitation, any trademark or other notices related to the intellectual property of any space of the services of the ₹ Mandi platform; b) to reproduce, modify, perform derivative works, destroy, license, rent, sell, resell, transfer, display or publicly perform, transmit, reproduce, broadcast, or otherwise exploit the services of the ₹ Mandi platform, except to the extent expressly permitted by Agri MP; (c) to decompile, reverse engineer or disassemble the ₹ Mandi platform, except to the extent permitted by applicable law; (d) to create links or frame any part of the ₹ Mandi platform; (e) to create or launch any programs or scripts to capture, index, collect or otherwise extract data from any part of the ₹ Mandi platform, or unduly overloading and / or preventing the operation and /or functionality of the ₹ Mandi platform ; or (f) to attempt to get unauthorized access to the ₹ Mandi platform or impair any aspect of the ₹ Mandi platform or its systems or networks.
            </li>
            </ul>
            <li className="termsConditions-list-title">CONDITIONS OF USE AND OPERATION OF THE ₹ Mandi PLATFORM</li>
            <div className="termsConditions-list-subTitle">What are the conditions of access?</div>
            <ul className="termsConditions-listNumeric">
            <li className="termsConditions-list-item">
                To access the services of the ₹ Mandi platform, in addition to the acceptance of these Terms and Conditions, it is necessary to create an Account
            </li>
            <li className="termsConditions-list-item">
            ...
            <li className="termsConditions-list-item">
                Payment data shall be validated by Agri EM back office and its Payment Service Provider Partner, Lemon Way, within a 24-48 hours period. After this validation and approval, the User may use the ₹ Mandi platform.
            </li>
            <li className="termsConditions-list-item">
                The ₹ Mandi platform only allows one Account per User, unless expressly provided otherwise. 
            </li>
            <li className="termsConditions-list-item">
                The User guarantees the accuracy, completeness and timeliness of the information that he/she submits. If the information submitted proves to be false, incomplete or outdated, Agri EM may disable the User's access to the ₹ Mandi platform. 
            </li>
            <li className="termsConditions-list-item">
            ...
            <li className="termsConditions-list-item">
                The User undertakes to immediately notify ₹ Mandi if he/she becomes aware of an unauthorized use or any other breach of security relating to his/her Account. 
            </li>
            <li className="termsConditions-list-item">
            ...
            <li className="termsConditions-list-item">
                With the creation of the Account, the User is entitled to access the network provided by the ₹ Mandi platform, according to these Terms and Conditions.
            </li>
            </ul>
            ...
            <ul className="termsConditions-listNumeric">
            <li className="termsConditions-list-item">
            The ₹ Mandi platform allows: (a) the placement of information regarding the sale and / or provision of Services; (b) to make orders for purchase and / or provision of Services to the Sellers and / or Services Providers; and (c) intermediation by ₹ Mandi of any payments to be made by the Customer to the Sellers and / or Services Providers, against the payment of a commission to Agri MP. This commission shall be paid to Agri EM by the Customers and by the Sellers and / or Services Providers.
            </li>
            <li className="termsConditions-list-item">
                Through the ₹ Mandi platform, the Sellers and / or Services Providers may (i) place any information on the selling of agricultural products and / or the provision of Services, and / or (ii) release on ₹ Mandi their intention to sell agricultural products and / or to provide Services.
            </li>
            <li className="termsConditions-list-item">
                In turn, the Customer may: (i) launch in the ₹ Mandi platform his/her intention to request the purchase of agricultural products and / or the provision of Services, and / or (ii) request the provision of Services and / or the purchase of agricultural products to the Sellers and / or Services Providers registered therein. To this end, the Customer shall indicate in the ₹ Mandi platform any data requested, namely the product that he/she intends to purchase and / or the Service to be provided, the price, location and intended date for delivery and / or provision of the Service. 
            </li>
            <li className="termsConditions-list-item">
            ...
            <li className="termsConditions-list-item">
                The User product / Service may not be published on the ₹ Mandi platform immediately upon its submission by the User and may take up to 24 hours to be available on the ₹ Mandi platform.
            </li>
            <li className="termsConditions-list-item">
            ...
            <ul className="termsConditions-listNumeric">
            <li className="termsConditions-list-item">
                The price due for the products / services purchased by the Customer shall be the price defined on the ₹ Mandi, considering the prices indicated by the Seller / Services Provider and any other condition applicable to the purchase and sale or provision of services.
            </li>
            <li className="termsConditions-list-item">
            ...
            <ul className="termsConditions-listNumeric">
            <li className="termsConditions-list-item">
                In order to be able to carry out operations on the ₹ Mandi platform, the Customer must, when setting up the Account, enter the information requested to create a virtual account balance through which payments for the products and / or services purchased shall be made
            </li>
            <li className="termsConditions-list-item">
            ...
            <li className="termsConditions-list-item">
                Upon completion of (i) acceptance by the Customer of the budget submitted by the Services Provider or the price of the product; or (ii) acceptance by the Customer of the Seller or the Services Provider proposal of his/her request intention, ₹ Mandi shall forward the Customer to the service / product payment page
            </li>
            <li className="termsConditions-list-item">
                ₹ Mandi shall charge (i) the price due for the products and / or Services, under the terms agreed between the Customer and the Seller and / or Services Provider, and indicated in the ₹ Mandi platform, and (ii) the amount due to Agri EM for the services provided by the ₹ Mandi platform according to the procedure described above.
            </li>
            </ul>
            ...
            <ul className="termsConditions-listNumeric">
            <li className="termsConditions-list-item">
            Except otherwise provided in Sections 4 and 5 below, the price of the products / services charged to the Customer shall be charged to the ₹ Mandi virtual account of the Seller / Services Provider and forwarded through the Lemon Way platform to the bank account of the Seller/ Service Provider. This process shall be repeated for all payments that may be made as a result of the payment terms agreed upon.
            </li>
            <li className="termsConditions-list-item">
            Upon receipt of the price due by the Customer pursuant to the terms of the preceding paragraphs, invoices regarding to the price of the products and / or services and the amount due to Agri EM for the services made available on the ₹ Mandi platform shall be issued and sent to the Customer directly by the Seller and / or Services Provider and by Agri MP, respectively. 
            </li>
            </ul>
            <li className="termsConditions-list-title">USER'S OBLIGATIONS</li>
            <ul className="termsConditions-listNumeric">
            <li className="termsConditions-list-item">
            The User undertakes not to directly contract or make any direct payments to other Users of the ₹ Mandi network, with whom he/she has had contacts through this network, other than through the ₹ Mandi platform.
            </li>
            <li className="termsConditions-list-item">
            The User further undertakes not to create, copy, reproduce, modify or use in any way any content of the ₹ Mandi platform, and not to use works and requests that have been made known to him/her by this means directly with the Seller and / or Services Provider.
            </li>
            <li className="termsConditions-list-item">
            The User agrees not to use services for purposes other than those for which they are intended, namely illicit purposes. 
            </li>
            <li className="termsConditions-list-item">The User undertakes not to send to third parties or otherwise disclose any request existing in the ₹ Mandi platform or to distribute or publicly display any content of the ₹ Mandi platform without prior and express permission of Agri MP. 
            </li>
            <li className="termsConditions-list-item">The content published by the User on the ₹ Mandi platform is owned by the User. However, the User assigns to ₹ Mandi, to the extent permitted by law, a free and perpetual license to use, copy, modify, create derivative works, distribute, perform in any way, or otherwise exploit the content in all formats and distribution channels, without the need for any prior notice or consent of the User and without there being any compensation to this effect.</li>
            <li className="termsConditions-list-item">The User further declares that: (a) the activities pursued through the ₹ Mandi platform comply with the applicable rules, regulations and legislation in force; (b) he/she carries out commercial transactions with other Users in good faith; (c) he/she complies with the agreements concluded through the ₹ Mandi platform and in the terms indicated therein; (d) he/she shall not impersonate any other person or entity or misrepresenting his/her relationship with any other entity;
            </li>
            <li className="termsConditions-list-item">Upon knowledge of any violation or potential violation of these Terms and Conditions, ₹ Mandi reserves the right (but shall have no obligation) to decide whether the User meets the requirements of these Terms and Conditions and may, at any time and without prior notice, terminate any User’s access to the ₹ Mandi platform.
            </li>
            <li className="termsConditions-list-item">The conditions applicable to the processing of the User’s personal data that may be collected by Agri MP, directly or through the ₹ Mandi platform, are best described in the Privacy Policy of ₹ Mandi and its partners, available on the <a target="_blank" className="link-green" href="/privacy"><span className="translation_missing" title="translation missing: en.terms_conditions.en_show.privacy">Privacy</span></a> web page .
            </li>
            <li className="termsConditions-list-item">The User undertakes to respect the personal data submitted in the ₹ Mandi platform, namely not to proceed to its disclosure, publication or interception.
            </li>
            <li className="termsConditions-list-item">The User is responsible for obtaining the necessary access to the data network in order to use the services provided by the ₹ Mandi platform. The fees and rates of the data and messages network of the mobile equipment of the User may apply, should the User access to or use the Services from a wireless device, and the User is responsible for paying such fees and rates. The User is responsible for acquiring and updating the equipment or devices required to access and use the services and any updates thereof. The ₹ Mandi platform services may be subject to failures and / or delays inherent to the use of the Internet and electronic communications. Agri EM does not guarantee the operation of the ₹ Mandi platform or that the ₹ Mandi platform services or any part thereof will work on a particular equipment or device.
            </li>
            </ul>
            <li className="termsConditions-list-title">AGRI EM LIABILITY AND LIMITATION OF LIABILITY</li>
            <ul className="termsConditions-listNumeric">
            <li className="termsConditions-list-item">
            Agri EM guarantees that it is in a legitimate and legal position to market and provide the ₹ Mandi platform.
            </li>
            <li className="termsConditions-list-item">
            There is no relationship between Agri MP, the Customer, the Seller and / or Services Provider other than the availability of the ₹ Mandi platform, as provided in these Terms and Conditions. The Customer acknowledges that the purchase and sale of products and / or that the Services provided or rendered by the Sellers and / or Services Providers, which act on their own account and responsibility, and that Agri EM is not, in any way, part the contractual relationship established between the Customer, the Seller and / or Services Provider.  
            </li>
            <li className="termsConditions-list-item">
            ...
            <li className="termsConditions-list-item">
            In order to meet the User’s trust and expectation, EM Agri verifies whether the Sellers and / or Services Providers comply with the quality standards of Agri EM to sell the products and provide the services made available on the ₹ Mandi platform. Agri EM also ensures the binding of the Sellers and / or Services Providers registered in the ₹ Mandi platform network to the obligation to supply the products and to perform the services with the greatest accuracy, fairness, and diligence.
            </li>
            <li className="termsConditions-list-item">
            ...
            <li className="termsConditions-list-item">
            Agri EM is not responsible in any way for: (a) any type of dispute, default or damage arising from the contractual relationship between the Users through the ₹ Mandi platform; (b) any damage caused to third parties as a result of the supply of the products by the Seller or the execution of services by the Services Provider; (c) any damage, injury or loss arising from the use or trust created in the services provided by Agri MP, including any failures or interruptions in the functioning of the ₹ Mandi platform and the inability to access the ₹ Mandi platform; (d) any damage that may result from a malfunction of the ₹ Mandi platform, either by computer failure, viruses, Trojan horses, worms or something causing interference in the system.
            </li>
            <li className="termsConditions-list-item">
            The information available on the ₹ Mandi platform concerning the products, the Sellers, the Services Providers and the Customers is provided by the Users. Agri EM assumes no responsibility for any error, omission, inaccuracy or falsity of the information transmitted by the Users. Agri EM is in no way responsible for the information contained in the ₹ Mandi platform.
            </li>
            <li className="termsConditions-list-item">
            The ₹ Mandi platform may be made available or accessible within the scope of a third-party service and content outside the control of Agri MP. The User acknowledges that the use of a third-party services and content may be subject to their terms of use and privacy policies. Agri EM provides no warranty and is not responsible for such third-party services and content. Additionally, any third-party beneficiaries of the use of the ₹ Mandi platform are not part of the relationship between the User and Agri EM or between Users. Access to the ₹ Mandi services, by the User, through a third-party equipment, services and / or content is subject to the conditions stipulated in the terms and conditions applicable to the service of the third-party.
            </li>
            </ul>
            <li className="termsConditions-list-title">COMPLAINTS</li>
            <ul className="termsConditions-listNumeric">
            <li className="termsConditions-list-item">
            Agri EM provides a tool in the ₹ Mandi platform, for the benefit of the Customer, for presentation of complaints regarding the Seller and / or Services Provider or the product and / or service provided, acting as mediator in these cases. This service is provided only for the better functioning of the ₹ Mandi platform and for a more efficient and faster resolution of disputes arising from the contractual relationship between the Users.
            </li>
            <li className="termsConditions-list-item">
            Any Customer complaint should always be addressed to Agri MP, through the means available on the ₹ Mandi platform, namely to the email info@agrimp.com, which shall communicate it to the Seller and / or Services Provider within two (2) days. The Seller and / or Services Provider has a two (2) days term to send Agri EM a reply to the complaint presented. 
            </li>
            <li className="termsConditions-list-item">
            ...
            <li className="termsConditions-list-item">
            These Terms and Conditions contain the entire agreement between Agri EM and the User. Agri EM reserves the right to, at any time, alter these Terms and Conditions in any way. Whenever changes are made to the applicable Terms and Conditions, Users shall be presented, when accessing the ₹ Mandi platform, a notice informing them of such fact and a request for acceptance of the new Terms and Conditions. Without this acceptance, Users shall not be able to continue to access and use the ₹ Mandi platform. 
            </li>
            <li className="termsConditions-list-item">
